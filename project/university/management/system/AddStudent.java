...
public class AddStudent extends JFrame implements ActionListener {
    ...
    AddStudent() {
        ...
        labelrollno = new JLabel("1553"+first4);// for visible of text;
        ...
        String[] programs = {"B.tech", "MBA", "Bsc", "Msc", "BBA", "M.tech"};
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == cancel){
            ...
            try {
                String query = "insert into student values('" + sname + "','" + sfname + "','" + srollno + "','" + sdob + "','" + sadress + "','" + sphone + "','" + semail + "','" + sClassX + "','" + sClassXII + "','" + sadhar + "','" + scourse + "' , '" + sbranch + "')";
